...
//#include "mcu.h"
extern void Tim_IRQHandler(uint8_t u8Param);
extern void Tim3_IRQHandler(uint8_t u8Param);
extern void Adc_IRQHandler(uint8_t u8Param);
extern void Gpio_IRQHandler(uint8_t u8Param);
