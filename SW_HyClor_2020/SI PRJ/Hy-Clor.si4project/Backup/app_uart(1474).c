...
unsigned char IOT_RESOLVE_WIFI_ONLINE(struct Aura4GRec * pparam)
{
...
unsigned char IOT_RESOLVE_WIFI_DATA(struct Aura4GRec * pparam)
{
	unsigned char temp=0;
...
unsigned char IOT_RESOLVE_DATA_UDP(struct ST_PACKAGE * pparam)
{
/***********************************************************************/
#if 0
	//481c55e223:aabbccddeeff:192.168.0.166:1234
...
unsigned char IOT_RESOLVE_DATA_ONOFF(struct Aura4GRec * pparam)
{
#if 0
...
/***********************************************************************/
			...
			OUTIF:
//			IOKeepOnlineCnt=0;
//			System_20_Tick_Cnt_remember=System_20_Tick_Cnt_remember;
		}
    }
#endif
