...
#else
	uiTemp = 805664;
	uiTemp2 = CAL_REF_GAIN - ucCurrentCalValue;
...
void CalibrateParameter(void)
{
	...
	if(ucGainValue>=CAL_REF_GAIN)
		ucGainValue = 0;
	else
		ucGainValue = CAL_REF_GAIN- ucGainValue;
#endif
}
#endif
