...
//Timer 1
    ...
    stcBtTimer1Cfg.enPRS      = BtPCLKDiv32;//BtPCLKDiv4//BtPCLKDiv64;                  //PCLK/64
    stcBtTimer1Cfg.enCntMode  = BtPCLKDiv4;               //自动重载16位计数器/定时器
